// scripts/generate.js
// Run ONCE with: npm run generate
// Saves all article data to public/data/*.json
...
if (!API_KEY || API_KEY.includes("your-key")) {
  ...
  console.error("    Copy .env.local.example → .env.local and paste your key.\n");
  process.exit(1);
}
...
const ARTICLES = [
  ...
  { id:"4",  num:"4",  title:"Laws under Arts. 2 & 3 to provide for amendment of First and Fourth Schedules", partName:"Part I", partSubtitle:"The Union and its Territory" },

  // Part II
  { id:"5",  num:"5",  title:"Citizenship at commencement of the Constitution", partName:"Part II", partSubtitle:"Citizenship" },
  { id:"6",  num:"6",  title:"Rights of citizenship of persons who migrated to India from Pakistan", partName:"Part II", partSubtitle:"Citizenship" },
  { id:"7",  num:"7",  title:"Rights of citizenship of certain migrants to Pakistan", partName:"Part II", partSubtitle:"Citizenship" },
  { id:"8",  num:"8",  title:"Rights of citizenship of certain persons of Indian origin residing outside India", partName:"Part II", partSubtitle:"Citizenship" },
  { id:"9",  num:"9",  title:"Persons voluntarily acquiring citizenship of a foreign State not to be citizens", partName:"Part II", partSubtitle:"Citizenship" },
  ...
  { id:"13",  num:"13",  title:"Laws inconsistent with or in derogation of the Fundamental Rights", partName:"Part III", partSubtitle:"Fundamental Rights" },
  ...
  { id:"24",  num:"24",  title:"Prohibition of employment of children in factories etc.", partName:"Part III", partSubtitle:"Fundamental Rights" },
  ...
  { id:"31A", num:"31A", title:"Saving of Laws providing for acquisition of estates etc.", partName:"Part III", partSubtitle:"Fundamental Rights" },
  ...
  { id:"33",  num:"33",  title:"Power of Parliament to modify rights conferred by this Part in application to Forces", partName:"Part III", partSubtitle:"Fundamental Rights" },
  { id:"34",  num:"34",  title:"Restriction on rights conferred by this Part while martial law is in force", partName:"Part III", partSubtitle:"Fundamental Rights" },
  ...
  { id:"38",  num:"38",  title:"State to secure a social order for the promotion of welfare of the people", partName:"Part IV", partSubtitle:"Directive Principles of State Policy" },
  ...
  { id:"43",  num:"43",  title:"Living wage etc. for workers", partName:"Part IV", partSubtitle:"Directive Principles of State Policy" },
  ...
  { id:"64",  num:"64",  title:"The Vice-President to be ex-officio Chairman of the Council of States", partName:"Part V", partSubtitle:"The Union" },
  { id:"65",  num:"65",  title:"The Vice-President to act as President or to discharge his functions", partName:"Part V", partSubtitle:"The Union" },
  { id:"66",  num:"66",  title:"Election of Vice-President", partName:"Part V", partSubtitle:"The Union" },
  { id:"72",  num:"72",  title:"Power of President to grant pardons reprieves respites or remissions of punishment", partName:"Part V", partSubtitle:"The Union" },
  ...
  { id:"78",  num:"78",  title:"Duties of Prime Minister as respects the furnishing of information to the President", partName:"Part V", partSubtitle:"The Union" },
  ...
  { id:"105", num:"105", title:"Powers privileges etc. of the Houses of Parliament and of the members", partName:"Part V", partSubtitle:"The Union" },
  ...
  { id:"167", num:"167", title:"Duties of Chief Minister as respects the furnishing of information to Governor", partName:"Part VI", partSubtitle:"The States" },
  ...
  { id:"243E", num:"243E", title:"Duration of Panchayats etc.", partName:"Part IX", partSubtitle:"The Panchayats" },
  ...
  { id:"356", num:"356", title:"Provisions in case of failure of constitutional machinery in States (President's Rule)", partName:"Part XVIII", partSubtitle:"Emergency Provisions" },
...
{
  "articleText": "The complete verbatim text of this constitutional provision with all clauses and sub-clauses. For the Preamble, give the full preamble text.",
...
Rules:
- 3-5 real landmark judgements directly related to this article.
- 4-5 UPSC/State PSC questions; set yearAsked to null if created.
- correctAnswer must be exactly "a", "b", "c", or "d".
- Be constitutionally accurate throughout.`;
}

// ─── API call with retry ─────────────────────────────────────────────────────
async function callAPI(article, attempt = 1) {
  ...
  if (res.status === 429 || res.status >= 500) {
    if (attempt <= 4) {
      ...
      return callAPI(article, attempt + 1);
    }
...
async function main() {
  ...
  for (let i = 0; i < ARTICLES.length; i++) {
    ...
    process.stdout.write(
      `\r${bar(done, total)} ${done}/${total}  Generating ${label.padEnd(12)}...`
    );

    try {
      const data = await callAPI(article);
